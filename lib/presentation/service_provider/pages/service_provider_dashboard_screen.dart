...
import 'package:homeconnect/presentation/service_provider/pages/provider_conversations_screen.dart';
                ...
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder:
                          (_) =>
                              AllJobRequestsScreen(), // Changed from AllJobRequestsScreen
                    ),
                  );
                },
        ...
        children: [
          ...
          _buildManagementCard(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => AllJobRequestsScreen()),
              );
            },
