...
class ProfileDisplayScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor:
            Colors.blueAccent, // Added a background color for AppBar
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                  ...
                  child: Stack(
                    children: [
                      CircleAvatar(
                        ...
                        backgroundColor:
                            Colors.blue.shade100, // Light background for avatar
                        backgroundImage:
                ...
                Center(
                  child: Text(
                    data['name'] ?? 'N/A', // Added N/A for null case
                ...
                Center(
                  child: Text(
                    data['email'] ??
                        '', // Assuming email might be available for display
                ...
                Container(
                  ...
                  child: Text(
                    data['description'] ??
                        'No description provided.', // Added placeholder
                      ...
                      (categories as List<dynamic>)
                          .map(
                            (cat) => Chip(
                              ...
                              backgroundColor:
                                  Colors.lightBlue.shade100, // Styled chip
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor:
                          Colors.blueAccent, // Changed button color
                      padding: const EdgeInsets.symmetric(
                        vertical: 16,
                      ), // Increased padding
  ...
  Widget _buildSectionTitle(BuildContext context, String title, IconData icon) {
    return Padding(
      ...
      child: Row(
        children: [
          Icon(icon, color: Colors.deepPurple, size: 22), // Styled icon
  ...
  // Helper widget for consistent profile detail rows
